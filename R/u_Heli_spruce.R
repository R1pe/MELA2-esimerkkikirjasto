...
#' @title u_Heli_spruce Earlywood
#' @param latewood latewood
#' @param Heli_e Heli_e term
#' @alias lw latewood
#' @alias heli Heli_e
#' @check species {2}
#' @check latewood (0,)
...
#' @title u_Heli_spruce Fibre
#' @param diameter_h diameter under bark at height h
#' @param age_h number of annual rings (age) at height h
#' @param tempsum temperature sum
#' @param relative_h relative height of the tree
#' @param heli Heli_f
#' @alias dh diameter_h
#' @alias ch age_h
#' @alias ts tempsum
